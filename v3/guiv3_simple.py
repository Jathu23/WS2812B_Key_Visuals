...
class LEDControllerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Professional LED Controller v3 - Simple")
    ...
    def setup_ui(self):
        ...
        key_frame = tk.LabelFrame(main_frame, text="Key Reactive Effects", bg='#2b2b2b', fg='white', font=('Arial', 12, 'bold'))
        ...
        self.log("LED Controller GUI v3 Simple Started")
